            ...
            <div style={styles.ContentContainer}>
              ...
              <div style={styles.DetailsContainer}>
                ...
                <div style={styles.CatMonthlyContainer}>
                  <button style={styles.BackButton} onClick={handleBack}>
                    <img style={styles.keyboardBack} src = {back_button}/>
                    <b style={styles.MonthTitleHeader}>May 2024</b>
                  </button>
                  <div style={styles.UpdateContainer}>
                    <img style={styles.MonthlyPicture}></img>
                    <p style={styles.CaptionStyle}>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                  </div>
                </div>
              </div>
            </div>
